...
<html>
 <head>
  <title>INTC Historical Price</title>
 ...
 <?php
    ...
    $database ="database";
    try{
        $sql = "SELECT * FROM database.intc WHERE database.intc.Date LIKE '%2019%'";
...
?>
  <div class="container">
   <div class="table-responsive">
    <h1>INTC Historical Price <button onclick="exportTableToCSV('intc.csv')">Download Historical Data</button></h1>
    <br />
    <table id="intc_table" style="width: 420px">
    <thead>
    <tr>
      <th>Date</th>
      <th>Open</th>
