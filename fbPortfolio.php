...
<html>
 <head>
  <title>FB Historical Price</title>
 ...
 <?php
    ...
    $database ="database";
    try{
        $sql = "SELECT * FROM database.fb WHERE database.fb.Date LIKE '%2019%'";
...
?>
  <div class="container">
   <div class="table-responsive">
    <h1>FB Historical Price <button onclick="exportTableToCSV('fb.csv')">Download Historical Data</button></h1>
    <br />
    <table id="fb_table" style="width: 420px">
    <thead>
    <tr>
      <th>Date</th>
      <th>Open</th>
